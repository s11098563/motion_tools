# Speed Calculator, Connor Cook, April 09, 2021, 2:00PM v0.1
...
while keep_going == "Yes" or keep_going == "yes":
    ...
    print(f"Using the distance of {distance} meters and the time of {time} seconds, the speed is {speed} m/s.\n")
